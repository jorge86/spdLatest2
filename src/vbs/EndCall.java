...
//        String loginCheck =driverOperator.findElement(By.xpath("//div[@class='text-danger errorMessage']")).getTagName();
//        if (loginCheck.equalsIgnoreCase("*Some services are down. Could not connect!")){
//            System.out.println("Login ok"+loginCheck);
//        }
//        else {
//            System.out.println("Login NOK"+loginCheck);
//        }
        ...
        //End Call
        driverOperator.findElement(By.xpath("//span[contains(text(),'End Call')]")).click();

        //Assertion
        String URL = driverDevice.findElement(By.xpath("//button[@type='button']")).getTagName();

        if (URL.equalsIgnoreCase("button")){
